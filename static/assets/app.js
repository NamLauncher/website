...
const translations = {
  en: {
    "meta.home.title": "NamLauncher 1.2.4 Stable - Minecraft Launcher by Nattapat2871",
    "meta.home.description": "Keep Minecraft instances separate, choose Vanilla, Fabric, Forge, NeoForge, or Quilt, and install compatible content from Modrinth or CurseForge with NamLauncher 1.2.4.",
    ...
    "hero.eyebrow": "Windows 1.2.4 stable · Linux 1.2.4 stable · macOS 1.2.4 stable",
    ...
    "stats.source": "Source code",
    "stats.sourceRepo": "GitHub repository",
    "stats.sourceAria": "Open NamLauncher source code on GitHub",
    ...
    "latest.eyebrow": "New in 1.2.4",
    "latest.title": "Skins, instance tools, and automatic updates now work together.",
    "latest.intro": "Version 1.2.4 adds the NameMC skin library, per-user Windows updates, loader notices, exact mod versions, and a more responsive themed interface.",
    "latest.library.title": "Browse and apply NameMC skins inside the launcher.",
    "latest.library.body": "Search by player or tag, move through pages, preview stars and arm models, then apply and save a skin without leaving NamLauncher.",
    "latest.tags.aria": "Release capabilities",
    "latest.tags.dependencies": "NameMC skin library",
    "latest.tags.hashes": "Verified per-user updater",
    "latest.tags.compatible": "Loader and mod updates",
    "latest.preview.search": "Search skins and tags",
    "latest.preview.mod": "NamLauncher 1.2.4",
    "latest.preview.install": "Ready",
    "latest.toggle.title": "Windows updates move safely to Current User",
    "latest.toggle.body": "Normal updates no longer need administrator confirmation. A verified legacy All Users install is migrated while the existing launcher data path is preserved.",
    "latest.version.title": "Loader and mod versions are easier to understand",
    "latest.version.body": "New loader notices, distinct stable or unstable badges, and exact mod-version selection keep each instance under your control.",
    ...
    "screenshots.intro": "These screenshots come from the launcher itself: Home, instance content, worlds and servers, saved skins, the NameMC skin library, the mod library, and instance creation.",
    ...
    "screenshots.skinLibrary.title": "Browse the NameMC skin library",
    "screenshots.skinLibrary.body": "Search public skins, filter popular and recent results, compare star counts, and preview a skin before using it.",
    "screenshots.skinLibrary.open": "Open the full-size NamLauncher NameMC skin library screenshot (opens in a new tab)",
    ...
    "download.eyebrow": "Windows 1.2.4 stable · Linux 1.2.4 stable · macOS 1.2.4 stable",
    "download.title": "Download NamLauncher 1.2.4 for your computer.",
    ...
    "download.codeSigningPolicy": "Code signing policy",
    ...
    "download.linux.heading": "Linux 1.2.4 stable",
    ...
    "legal.tos.beta.body": "NamLauncher 1.2.4 is distributed without Windows or macOS code-signing certificates and may still contain defects. Verify official downloads and back up saves, instances, screenshots, mods, and other important data before updates or migrations.",
  ...
  th: {
    "meta.home.title": "NamLauncher 1.2.4 Stable - ลันเชอร์ Minecraft โดย Nattapat2871",
    "meta.home.description": "NamLauncher 1.2.4 แยกอินสแตนซ์ Minecraft รองรับ Vanilla, Fabric, Forge, NeoForge และ Quilt พร้อมค้นหาม็อดจาก Modrinth หรือ CurseForge",
    ...
    "stats.source": "ซอร์สโค้ด",
    "stats.sourceRepo": "รีโพ GitHub",
    "stats.sourceAria": "เปิดซอร์สโค้ด NamLauncher บน GitHub",
    ...
    "latest.eyebrow": "ใหม่ใน 1.2.4",
    "latest.title": "สกิน เครื่องมืออินสแตนซ์ และการอัปเดตอัตโนมัติทำงานร่วมกันแล้ว",
    "latest.intro": "เวอร์ชัน 1.2.4 เพิ่มไลบรารีสกิน NameMC การอัปเดต Windows แบบผู้ใช้ปัจจุบัน การแจ้ง Loader รุ่นใหม่ การเลือกเวอร์ชันมอด และ UI ที่ปรับตามขนาดและธีม",
    "latest.library.title": "ค้นหาและใช้สกิน NameMC ได้ภายในลันเชอร์",
    "latest.library.body": "ค้นหาด้วยชื่อผู้เล่นหรือแท็ก เปิดหน้าถัดไป ดูตัวอย่าง จำนวนดาว และชนิดแขน จากนั้นใช้และบันทึกสกินได้โดยไม่ต้องออกจาก NamLauncher",
    "latest.tags.aria": "ความสามารถของรุ่นนี้",
    "latest.tags.dependencies": "ไลบรารีสกิน NameMC",
    "latest.tags.hashes": "อัปเดตแบบผู้ใช้พร้อมตรวจสอบ",
    "latest.tags.compatible": "อัปเดต Loader และมอด",
    "latest.preview.search": "ค้นหาสกินและแท็ก",
    "latest.preview.mod": "NamLauncher 1.2.4",
    "latest.preview.install": "พร้อม",
    "latest.toggle.title": "อัปเดต Windows และย้ายมาเป็น Current User อย่างปลอดภัย",
    "latest.toggle.body": "การอัปเดตปกติไม่ต้องขอสิทธิ์ผู้ดูแลระบบ และย้ายการติดตั้ง All Users รุ่นเก่าที่ตรวจสอบแล้วโดยรักษาโฟลเดอร์ข้อมูลเดิม",
    "latest.version.title": "เวอร์ชัน Loader และมอดอ่านได้ง่ายขึ้น",
    "latest.version.body": "มีการแจ้ง Loader รุ่นใหม่ ป้าย Stable หรือ Unstable ที่แยกชัด และการเลือกเวอร์ชันมอดแบบเจาะจงสำหรับแต่ละอินสแตนซ์",
    ...
    "screenshots.intro": "ภาพชุดนี้มาจากตัวลันเชอร์ ทั้งหน้าแรก เนื้อหาอินสแตนซ์ โลกและเซิร์ฟเวอร์ สกินที่บันทึก ไลบรารีสกิน NameMC ไลบรารีม็อด และหน้าสร้างอินสแตนซ์",
    ...
    "screenshots.skinLibrary.title": "เลือกสกินจากไลบรารี NameMC",
    "screenshots.skinLibrary.body": "ค้นหาสกินสาธารณะ กรองรายการยอดนิยมและรายการใหม่ ดูจำนวนดาว และเปิดตัวอย่างก่อนนำไปใช้",
    "screenshots.skinLibrary.open": "เปิดภาพหน้าจอไลบรารีสกิน NameMC ของ NamLauncher แบบเต็มขนาด (เปิดในแท็บใหม่)",
    ...
    "download.eyebrow": "Windows 1.2.4 stable · Linux 1.2.4 stable · macOS 1.2.4 stable",
    "download.title": "ดาวน์โหลด NamLauncher 1.2.4 ให้ตรงกับเครื่องของคุณ",
    ...
    "download.codeSigningPolicy": "นโยบายการลงลายเซ็นโค้ด",
    ...
    "footer.codeSigning": "นโยบายการลงลายเซ็นโค้ด",
    ...
    "legal.tos.beta.body": "NamLauncher 1.2.4 เผยแพร่โดยยังไม่มี certificate สำหรับลงลายเซ็นโค้ดบน Windows หรือ macOS และยังอาจมีข้อผิดพลาด โปรดตรวจไฟล์จากเว็บไซต์ทางการและสำรอง saves, instances, screenshots, mods และข้อมูลสำคัญก่อนอัปเดตหรือย้ายโฟลเดอร์",
...
function renderRichTranslation(element, key) {
  ...
  if (key === "footer.links") {
    fragment.append(
      ...
      document.createTextNode(" / "),
      createFooterLink(t("footer.codeSigning"), "/#code-signing-policy")
    );
  }
...
function renderStats(stats) {
  ...
  const version = stats.launcher_version || "1.2.4";
